...
var parseTests = []struct {
	...
	{
		"SELECT 1",
		`{"version":140005,"stmts":[{"stmt":{"SelectStmt":{"targetList":[{"ResTarget":{"val":{"A_Const":{"val":{"Integer":{"ival":1}},"location":7}},"location":7}}],"limitOption":"LIMIT_OPTION_DEFAULT","op":"SETOP_NONE"}}}]}`,
		&pg_query.ParseResult{
			Version: int32(140005),
						...
						Node: &pg_query.Node_SelectStmt{
							SelectStmt: &pg_query.SelectStmt{
								...
								TargetList: []*pg_query.Node{
									...
									pg_query.MakeResTargetNodeWithNameAndVal(
										"Owner",
										pg_query.MakeFuncCallNodeWithFormat(
											[]*pg_query.Node{
	...
	AS $$
		...
		END;
		$$;`,
		`{"version":140005,"stmts":[{"stmt":{"CreateFunctionStmt":{"funcname":[{"String":{"str":"change_trigger_v2"}}],"returnType":{"names":[{"String":{"str":"trigger"}}],"typemod":-1,"location":44},"options":[{"DefElem":{"defname":"language","arg":{"String":{"str":"plpgsql"}},"defaction":"DEFELEM_UNSPEC","location":53}},{"DefElem":{"defname":"as","arg":{"List":{"items":[{"String":{"str":"\n\t\tDECLARE\n\t\tBEGIN\n\t\t\tPERFORM 'dummy';\n\t\tEND;\n\t\t"}}]}},"defaction":"DEFELEM_UNSPEC","location":71}}]}},"stmt_len":126}]}`,
		&pg_query.ParseResult{
			Version: int32(140005),
			Stmts: []*pg_query.RawStmt{
				{
	...
	{
		`SELECT * FROM a(1)`,
		`{"version":140005,"stmts":[{"stmt":{"SelectStmt":{"targetList":[{"ResTarget":{"val":{"ColumnRef":{"fields":[{"A_Star":{}}],"location":7}},"location":7}}],"fromClause":[{"RangeFunction":{"functions":[{"List":{"items":[{"FuncCall":{"funcname":[{"String":{"str":"a"}}],"args":[{"A_Const":{"val":{"Integer":{"ival":1}},"location":16}}],"funcformat":"COERCE_EXPLICIT_CALL","location":14}},{}]}}]}}],"limitOption":"LIMIT_OPTION_DEFAULT","op":"SETOP_NONE"}}}]}`,
		&pg_query.ParseResult{
			Version: int32(140005),
			Stmts: []*pg_query.RawStmt{
				{
